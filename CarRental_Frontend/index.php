...
$featuredCars = $conn->query("
    SELECT CarID, CarName, MainImage, PricePerDay, Transmission, FuelType, Seats
    FROM cars
    ORDER BY CarID DESC
");
...
");
$blogStmt->execute();
$latestPosts = $blogStmt->get_result();
?>
    ...
    <div id="carouselId" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img src="assets/img/fact-bg.jpg" class="img-fluid w-100" alt="slide"/>
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-6 d-flex align-items-center">
                                <div>
                                    ...
                                    <a href="vehicle.php" class="btn btn-primary rounded-pill py-3 px-5">Xem danh sách xe</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-5">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-item">
                            <div class="pb-5">
                                ...
                                <p class="mb-0">VinaDrive cung cấp dịch vụ thuê xe nhanh chóng, minh bạch và tiện lợi. Chúng tôi giúp khách hàng dễ dàng chọn mẫu xe phù hợp cho công việc, du lịch, đưa đón hoặc nhu cầu di chuyển hằng ngày.
                                </p>
                            </div>
                            <div class="row g-4">
                                <div class="col-lg-6">
                            ...
                            <p class="text-item my-4">Với hệ thống xe đa dạng, thông tin giá thuê rõ ràng và hỗ trợ khách hàng trong suốt quá trình sử dụng, VinaDrive luôn hướng đến trải nghiệm thuê xe nhanh gọn, đúng nhu cầu và tiết kiệm thời gian.
                            </p>
                            <div class="row g-4">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-5 d-flex align-items-center">
                                    <a href="vehicle.php" class="btn btn-primary rounded py-3 px-5">Xem xe ngay</a>
                                </div>
                                <div class="col-lg-7">
                                    <div class="d-flex align-items-center">
                                        <img src="assets/img/avatars/attachment-img.jpg" class="img-fluid rounded-circle border border-4 border-secondary" style="width: 100px; height: 100px;" alt="Image">
                                        <div class="ms-4">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                        <div class="about-img">
                            ...
                            <div class="img-2">
                                <img src="assets/img/cars/about-img-1.jpg" class="img-fluid rounded w-100" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="categories-item p-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="assets/img/cars/<?php echo htmlspecialchars($car['MainImage']); ?>" class="img-fluid w-100 rounded-top home-car-img" alt="<?php echo htmlspecialchars($car['CarName']); ?>">
                            </div>
                            <div class="categories-content rounded-bottom p-4">
                                <h4><?php echo htmlspecialchars($car['CarName']); ?></h4>
                                ...
                                <div class="mb-4">
                                    <h4 class="bg-white text-primary rounded-pill py-2 px-4 mb-0"><?php echo number_format($car['PricePerDay'], 0, ',', '.'); ?> VNĐ/ngày</h4>
                                </div>
                                <div class="row gy-2 gx-0 text-center mb-4">
                                    <div class="col-4 border-end border-white">
                                        <i class="fa fa-users text-dark"></i> <span class="text-body ms-1"><?php echo (int)$car['Seats']; ?> ghế</span>
                                    </div>
                                    <div class="col-4 border-end border-white">
                                        <i class="fa fa-cogs text-dark"></i> <span class="text-body ms-1"><?php echo htmlspecialchars($car['Transmission']); ?></span>
                                    </div>
                                    <div class="col-4">
                                        <i class="fa fa-gas-pump text-dark"></i> <span class="text-body ms-1"><?php echo htmlspecialchars($car['FuelType']); ?></span>
                                    </div>
                                </div>
                                <a href="vehicle-detail.php?id=<?php echo (int)$car['CarID']; ?>" class="btn btn-primary rounded-pill d-flex justify-content-center py-3">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                <?php endwhile; ?>
...
<div class="container-fluid blog py-5 bg-light">
    <div class="container">
        ...
        <div class="text-center mt-5">
            <a href="blog.php" class="btn btn-primary rounded-pill py-3 px-5">Xem tất cả bài viết</a>
        </div>
    </div>
</div>
