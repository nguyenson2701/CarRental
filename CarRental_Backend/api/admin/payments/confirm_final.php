...
if (!$payment) {
    die('Khong tim thay thanh toan cuoi.');
}

if ($payment['PaymentStatus'] === 'Paid') {
    $target = $redirect === 'detail'
        ? "../../../../CarRental_Admin/bookings/detail.php?id=" . (int)$payment['BookingID'] . "&final_paid=1"
        : "../../../../CarRental_Admin/bookings/list.php?final_paid=1";
...
$target = $redirect === 'detail'
    ? "../../../../CarRental_Admin/bookings/detail.php?id=$bookingID&final_paid=1"
    : "../../../../CarRental_Admin/bookings/list.php?final_paid=1";
